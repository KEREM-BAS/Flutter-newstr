...
class TrBusinessScreen extends StatefulWidget {
  const TrBusinessScreen({Key? key}) : super(key: key);

  @override
  State<TrBusinessScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<TrBusinessScreen> {
  @override
